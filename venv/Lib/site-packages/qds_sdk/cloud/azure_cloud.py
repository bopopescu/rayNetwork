...
class AzureCloud(Cloud):
    ...
    def set_cloud_config(self,
                         ...
                         main_static_nic_name=None,
                         main_static_public_ip_name=None):
        '''
        ...
        Args:
            ...
            main_elastic_ip: It is the Elastic IP address for attaching to the cluster main

            main_static_nic_name: Name of NIC that has to be attached to cluster's main node

            main_static_public_ip_name: Name of Static Public Ip address that has to be attached
                to cluster's main node
        ...
        self.set_network_config(bastion_node_public_dns, persistent_security_groups,
                                main_elastic_ip, vnet_name, subnet_name,
                                vnet_resource_group_name, main_static_nic_name, main_static_public_ip_name)
    ...
    def set_network_config(self,
        ...
        self.network_config['main_elastic_ip'] = main_elastic_ip
        ...
        self.network_config['main_static_nic_name'] = main_static_nic_name
        self.network_config['main_static_public_ip_name'] = main_static_public_ip_name
    ...
    def set_cloud_config_from_arguments(self, arguments):
        self.set_cloud_config(compute_client_id=arguments.compute_client_id,
                              ...
                              main_static_nic_name=arguments.main_static_nic_name,
                              main_static_public_ip_name=arguments.main_static_public_ip_name)
    ...
    def create_parser(self, argparser):
        ...
        network_config_group.add_argument("--main-static-nic-name",
                                          dest="main_static_nic_name",
                                          help="name of NIC to be attached to main node")
        network_config_group.add_argument("--main-static-public-ip-name",
                                          dest="main_static_public_ip_name",
                                          help="name of public IP to be attached to main node")
