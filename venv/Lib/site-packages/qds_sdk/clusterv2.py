...
class ClusterInfoV2(object):
    ...
    def set_cluster_info(self,
        ...
        Args:
                ...
                `heterogeneous_config` : Configuring heterogeneous nodes in Hadoop 2 and Spark clusters.
                    It implies that subordinate nodes can be of different instance types
        ...
        """
        self.cluster_info['main_instance_type'] = main_instance_type
        self.cluster_info['subordinate_instance_type'] = subordinate_instance_type
        ...
        self.cluster_info['subordinate_request_type'] = subordinate_request_type
    ...
    def cluster_info_parser(argparser, action):
        ...
        cluster_info.add_argument("--main-instance-type",
                                  dest="main_instance_type",
                                  help="instance type to use for the hadoop" +
                                       " main node")
        cluster_info.add_argument("--subordinate-instance-type",
        ...
        cluster_info.add_argument("--subordinate-request-type",
