...
class Cluster(Resource):
    ...
    @classmethod
    def main(cls, cluster_id_label):
        """
        Show the details of the main of the cluster with id/label `cluster_id_label`.
        """
        cluster_status = cls.status(cluster_id_label)
        if cluster_status.get("state") == 'UP':
            return list(filter(lambda x: x["role"] == "main", cluster_status.get("nodes")))[0]
        else:
    ...
    def _parse_create_update(cls, args, action, api_version):
        ...
        ec2_group.add_argument("--main-elastic-ip",
                               dest="main_elastic_ip",
                               help="elastic ip to attach to main",)
        ...
        node_config_group.add_argument("--main-instance-type",
                                  dest="main_instance_type",
                                  help="instance type to use for the hadoop" +
                                       " main node",)
        node_config_group.add_argument("--subordinate-instance-type",
                                  dest="subordinate_instance_type",
                                  help="instance type to use for the hadoop" +
                                       " subordinate nodes",)
        ...
        node_config_group.add_argument("--subordinate-request-type",
                                  dest="subordinate_request_type",
                                  choices=["ondemand", "spot", "hybrid", "spotblock"],
                                  help="purchasing option for subordinate instaces",)
        ...
        if api_version >= 1.3:
          ...
          fallback_to_ondemand_group.add_argument("--fallback-to-ondemand",
                                 ...
                                 " could not be obtained. Valid only if subordinate_request_type is spot",)
        ...
        spot_group = argparser.add_argument_group("spot instance settings" +
                    " (valid only when subordinate-request-type is hybrid or spot)")
        spot_group.add_argument("--maximum-bid-price-percentage",
                                ...
                                help="maximum value to bid for spot instances" +
                                     ...
                                     " price for the subordinate node instance type",)
        ...
        spot_group.add_argument("--maximum-spot-instance-percentage",
                                ...
                                help="maximum percentage of instances that may" +
                                     ...
                                     " valid only when subordinate-request-type" +
                                     " is 'hybrid'",)
        ...
        stable_spot_group.add_argument("--stable-maximum-bid-price-percentage",
                                       ...
                                       " expressed as a percentage of the base" +
                                       " price for the main and subordinate node instance types",)
...
class ClusterInfo():
    ...
    def set_ec2_settings(self,
        ...
        self.ec2_settings['main_elastic_ip'] = main_elastic_ip
        self.ec2_settings['bastion_node_public_dns'] = bastion_node_public_dns

    def set_hadoop_settings(self, main_instance_type=None,
                            subordinate_instance_type=None,
                            initial_nodes=None,
                            max_nodes=None,
                            custom_config=None,
                            subordinate_request_type=None,
                            use_hbase=None,
        ...
        `main_instance_type`: The instance type to use for the Hadoop main
            node.

        `subordinate_instance_type`: The instance type to use for the Hadoop subordinate
            nodes.
        ...
        `subordinate_request_type`: Purchasing option for subordinate instances.
        ...
        """
        self.hadoop_settings['main_instance_type'] = main_instance_type
        self.hadoop_settings['subordinate_instance_type'] = subordinate_instance_type
        ...
        self.hadoop_settings['subordinate_request_type'] = subordinate_request_type
    ...
    def set_spot_instance_settings(self, maximum_bid_price_percentage=None,
        ...
        `maximum_spot_instance_percentage`: Maximum percentage of instances
            ...
            subordinate_request_type is "hybrid".
        """
    ...
    def set_stable_spot_instance_settings(self, maximum_bid_price_percentage=None,
        ...
        `maximum_bid_price_percentage`: Maximum value to bid for stable node spot
            ...
            (applies to both main and subordinate nodes).
...
class ClusterInfoV13():
    ...
    def set_cluster_info(self, aws_access_key_id=None,
        ...
        `main_elastic_ip`: Elastic IP to attach to main node
        ...
        `fallback_to_ondemand`: Fallback to on-demand nodes if spot nodes could not be
            obtained. Valid only if subordinate_request_type is 'spot'.
        ...
        `maximum_bid_price_percentage`: ( Valid only when `subordinate_request_type` 
            is hybrid or spot.) Maximum value to bid for spot
            instances, expressed as a percentage of the base price 
            for the subordinate node instance type.
        ...
        self.enable_ganglia_monitoring = enable_ganglia_monitoring
        self.node_bootstrap_file = node_bootstrap_file
        self.set_node_configuration(main_instance_type, subordinate_instance_type, initial_nodes, max_nodes,
                                    subordinate_request_type, fallback_to_ondemand, custom_ec2_tags,
        ...
        self.set_ec2_settings(aws_access_key_id, aws_secret_access_key, aws_region, aws_availability_zone, vpc_id, subnet_id,
                              main_elastic_ip, bastion_node_public_dns, role_instance_profile)
    ...
    def set_node_configuration(self, main_instance_type=None,
                            subordinate_instance_type=None,
                            initial_nodes=None,
                            max_nodes=None,
                            subordinate_request_type=None,
                            ...
                            node_spot_cooldown_period=None,
                            root_volume_size=None):
        self.node_configuration['main_instance_type'] = main_instance_type
        self.node_configuration['subordinate_instance_type'] = subordinate_instance_type
        self.node_configuration['initial_nodes'] = initial_nodes
        self.node_configuration['max_nodes'] = max_nodes
        self.node_configuration['subordinate_request_type'] = subordinate_request_type
