...
from pyomo.contrib.gdpopt.main_initialize import (
    GDPopt_initialize_main, valid_init_strategies
)
...
class GDPoptSolver(object):
    ...
    CONFIG.declare("call_before_main_solve", ConfigValue(
        default=_DoNothing,
    ...
    CONFIG.declare("algorithm_stall_after", ConfigValue(
        default=2,
        description="number of non-improving main iterations after which "
    ...
    def solve(self, model, **kwds):
        ...
        initial main approximation and iteration loop.
...
- GLOA algorithm:
    ...
    DOI: 10.1016/S0098-1354(01)00732-3
            ...
            with time_code(solve_data.timing, 'initialization'):
                GDPopt_initialize_main(solve_data, config)
        ...
        solve_data.results.solver.iterations = solve_data.main_iteration
