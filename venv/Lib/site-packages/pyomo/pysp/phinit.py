...
def construct_ph_options_parser(usage_string):
    ...
    solverOpts.add_argument('--phpyro-transmit-leaf-stage-variable-solution',
      help="By default, when running PH using the PHPyro solver manager, leaf-stage variable solutions are not transmitted back to the main PH instance during intermediate PH iterations. This flag will override that behavior for the rare cases where these values are needed. Using this option will possibly have a negative impact on runtime for PH iterations. When PH exits, variable values are collected from all stages whether or not this option was used. Also, note that PH extensions have the ability to override this flag at runtime.",
      action="store_true",
    ...
    if (options.write_ef) or (options.solve_ef):
        ...
        if not isinstance(ph._solver_manager,
            ...
            ph._scenario_tree.linkInInstances(
                ...
                main_scenario_tree=ph._scenario_tree,
