...
class ClusterManagerClient(object):
    ...
    def update_main(
        ...
        Args:
            ...
            cluster_id (str): Deprecated. The name of the cluster to upgrade.
                This field has been deprecated and replaced by the name field.
            main_version (str): The Kubernetes version to change the main to.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if "update_main" not in self._inner_api_calls:
            self._inner_api_calls[
                "update_main"
            ] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.update_main,
                default_retry=self._method_configs["UpdateMain"].retry,
                default_timeout=self._method_configs["UpdateMain"].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls["update_main"](
            request, retry=retry, timeout=timeout, metadata=metadata
        )
    ...
    def set_main_auth(
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if "set_main_auth" not in self._inner_api_calls:
            self._inner_api_calls[
                "set_main_auth"
            ] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.set_main_auth,
                default_retry=self._method_configs["SetMainAuth"].retry,
                default_timeout=self._method_configs["SetMainAuth"].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls["set_main_auth"](
            request, retry=retry, timeout=timeout, metadata=metadata
        )
